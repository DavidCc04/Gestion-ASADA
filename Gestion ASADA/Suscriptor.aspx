<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Suscriptor.aspx.vb" Inherits="Gestion_ASADA.Suscriptor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <asp:Label ID="lblGestionSuscriptores" runat="server" Text="Sistema de Gestión de Suscriptores de la ASADA"></asp:Label>
    ...
    <asp:Button ID="btnGuardar" runat="server" Text="Guardar" CssClass="btn btn-primary my-2" />
